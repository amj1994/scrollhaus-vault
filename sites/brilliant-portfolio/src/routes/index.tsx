...
const lightSectionBackground = "linear-gradient(to bottom right, #CCDAE4 0%, #FDF8E3 35%, #F9F5EA 70%, #F8F4F1 100%)";
...
function ProjectCard({
  ...
  const mapStack = (distance: number, values: [number, number, number, number, number, number, number]) => {
...
function Index() {
  ...
  const textColor = useTransform(scrollYProgress, INPUT, ["#ffffff", "#ffffff", "#000000", "#000000"]);
  ...
  const markerBg = useTransform(scrollYProgress, INPUT, ["#ffffff", "#ffffff", "#000000", "#000000"]);
  ...
  const lightWordOpacities = Array.from({ length: 7 }, (_, i) =>
    ...
    useTransform(
      scrollYProgress,
      [LIGHT_WORD_START + i * LIGHT_WORD_STAGGER, LIGHT_WORD_START + i * LIGHT_WORD_STAGGER + LIGHT_WORD_DURATION],
      [0, 1],
    ),
  );
  ...
  const lightWordFilters = Array.from(
    ...
    (_, i) =>
      // eslint-disable-next-line react-hooks/rules-of-hooks
      useMotionTemplate`blur(${lightWordBlurs[i]}px)`,
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Layer z-10: sticky 3D coin — starts at the very first pixel of section 1 */}
        ...
        {/* Layer z-20: sticky UI — shares the same first-viewport start as the coin */}
        <div className="sticky top-0 left-0 w-full h-screen z-20 pointer-events-none -mt-[100vh]">
          {/* Vertical grid lines */}
          <div className="absolute inset-0 pointer-events-none">
            <motion.div style={{ backgroundColor: gridLineColor }} className="absolute top-0 bottom-0 left-1/4 w-px" />
            <motion.div style={{ backgroundColor: gridLineColor }} className="absolute top-0 bottom-0 left-1/2 w-px" />
            <motion.div style={{ backgroundColor: gridLineColor }} className="absolute top-0 bottom-0 left-3/4 w-px" />
          </div>
          ...
          <div className="relative h-full w-full [&_button]:pointer-events-auto [&_a]:pointer-events-auto">
                    ...
                    const word = (text: string, italic = false) => {
                      ...
                      return (
                        <motion.span
                          ...
                          transition={{ delay: 0.5 + idx * 0.22, duration: 1.8, ease: [0.22, 1, 0.36, 1] }}
            ...
            >
              <motion.img src={arrowRight} alt="" className="w-[11px] h-[10px]" style={{ filter: svgFilter }} />
              OUR WORKS
            </motion.button>
          </div>
        </div>

        {/* Layer z-0: native-scrolling backgrounds, pulled under the sticky coin/UI */}
      ...
      <div className="relative w-full">
        ...
        <section ref={worksRef} className="relative w-full h-[700vh] snap-start z-20 overflow-x-clip -mt-[50vh]">
          <div className="sticky top-0 w-full h-[100vh] overflow-visible flex items-center justify-center">
            ...
            <div
              ...
              style={{ background: "linear-gradient(to bottom right, #f8f5ea 0%, #f8f5ee 35%, #f7f4f0 70%, #F8F4F1 100%)" }}
            >
              <div className="absolute top-0 bottom-0 left-1/4 w-px bg-black/5" />
              <div className="absolute top-0 bottom-0 left-1/2 w-px bg-black/5" />
              <div className="absolute top-0 bottom-0 left-3/4 w-px bg-black/5" />
            ...
            <div className="absolute inset-0 z-30 text-white pointer-events-none hidden md:block">
              ...
              <div className="absolute top-8 right-6 lg:top-10 lg:right-12 flex items-start gap-6 lg:gap-[105px]">
                ...
                >
                  <img src={arrowRight} alt="" className="w-[11px] h-[10px]" style={{ marginRight: 14 }} />
                  CONTACT US
                </motion.button>
              </div>
