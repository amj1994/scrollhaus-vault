...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Pelmatech. A comprehensive online health platform — track your fitness goals, monitor nutrition, and schedule workouts.",
      },
      { property: "og:title", content: "Pelmatech — Your Personal Health Companion" },
      {
        property: "og:description",
        content: "Your personal online health companion.",
      },
