...
import doctorComputerSrc from "@/assets/doctor-computer.png";
import clockLampSrc from "@/assets/clock-lamp.png";
import pillsSrc from "@/assets/pills.png";
import waitlistSrc from "@/assets/waitlist.png";
      ...
      <div className="absolute inset-0 flex flex-col justify-end pb-16 px-8 md:px-12">
        <div className="flex items-end justify-between gap-8">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 w-max">
              <AnimatedText className="text-white/85 max-w-xl leading-relaxed">
                <span style={{ fontSize: "20.99px", lineHeight: "28.21px", display: "block", width: 608 }}>
                  Meet your personal online health companion — a comprehensive platform
                  offering tools for tracking your fitness goals, monitoring your nutrition,
                  and scheduling your workouts.
                </span>
              </AnimatedText>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 shrink-0 pb-1">
            ...
            <a href="#" className="text-white flex items-center gap-1 text-sm font-medium">
        ...
        <div
          className="border-t border-white/20 flex items-center justify-between tracking-[0.2em] text-white/70 uppercase mt-12 pt-5"
          style={{ fontSize: "12px" }}
        >
  ...
  return (
    <section className="py-32 px-8 md:px-12" style={{ fontFamily: TT_HOVES }}>
      <div style={{ paddingLeft: "335.26px" }}>
        <div
          className="flex gap-24 tracking-[0.2em] uppercase text-muted-foreground mb-16"
        ...
        <AnimatedHeading className="font-medium leading-[1.05]">
          <span style={{ fontSize: "58.55px", lineHeight: 1.05, display: "block", fontFamily: TT_HOVES }}>
        ...
        <TeamCarousel
          intro={
            <AnimatedText className="text-muted-foreground leading-relaxed">
              <span style={{ fontSize: "16.89px", lineHeight: 1.5, display: "block", width: 270, fontFamily: TT_HOVES }}>
                On our platform, our devoted team works ceaselessly to enhance our online
                presence and ensure the best possible customer experience.
              </span>
            </AnimatedText>
          }
        />
...
type Benefit = { title: string; desc: string; img: string; reversed?: boolean };
      ...
      <div className="grid grid-cols-12 gap-12 mb-24">
        ...
        <div className="col-span-12 md:col-span-4 md:col-start-9 md:pt-4">
          <AnimatedText className="text-base text-muted-foreground leading-relaxed">
            By choosing an online platform over an offline one, artists can reach a global
            audience more easily, connect with fans worldwide, and shape the future of music
            in a dynamic way.
          </AnimatedText>
        </div>
      </div>
        ...
        {BENEFITS.map((b, i) => {
          ...
          const image = (
            <div className="aspect-square overflow-hidden">
              <MaskedImage src={b.img} alt={b.title} className="w-full h-full" delay={i * 0.12} />
            </div>
          );

          return (
            <div key={b.title} className="p-10 flex flex-col gap-8">
              {b.reversed ? (
                <>
                  {image}
